...
"color:white;"));
        ...
        Btn_disconnect->setCursor(QCursor(Qt::ForbiddenCursor));
...
"color:white;"));
        ...
        Btn_download_2->setCursor(QCursor(Qt::PointingHandCursor));
...
"color:white;"));
        ...
        Btn_download_3->setCursor(QCursor(Qt::PointingHandCursor));
...
"color:white;"));
        ...
        Btn_clear_2->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        QFont font6;
        font6.setFamily(QString::fromUtf8("Bauhaus 93"));
        font6.setPointSize(10);
        font6.setBold(false);
        font6.setItalic(false);
        font6.setWeight(50);
        font6.setKerning(true);
        Btn_server_dir->setFont(font6);
        Btn_server_dir->setCursor(QCursor(Qt::OpenHandCursor));
        ...
        Brn_client_receive->setCursor(QCursor(Qt::OpenHandCursor));
...
""));
        ...
        Btn_client_send->setCursor(QCursor(Qt::OpenHandCursor));
        ...
        Btn_server_dir_2->setCursor(QCursor(Qt::OpenHandCursor));
...
" RECEIVE DIRECTORY", nullptr));
        ...
        Btn_server_dir->setAccessibleDescription(QString());
